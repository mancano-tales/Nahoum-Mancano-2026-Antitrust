...
|---|---|---|---|
| `2026-07-22_Plano_Revisao_Citacoes_Gerdau_Jobim.md` | PARCIAL | Claude Opus 4.8 (Claude Code, VS Code) | Revisão das citações de imprensa e de fontes primárias do caso Gerdau-Pains (Seção 4) |
...
| `2026-07-14_Plano_Revisao_Artigo_Coautor.md` | PARCIAL | Claude Sonnet 5 (Claude Code, VS Code) | Revisão do artigo com o coautor André Vereta-Nahoum: densidade dos casos, literatura (Ergen), trechos em português e infraestrutura de citação (.bib/Zotero) |
