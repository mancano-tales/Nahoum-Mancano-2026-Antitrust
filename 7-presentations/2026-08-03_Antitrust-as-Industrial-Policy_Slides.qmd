...
- **Mar 1995** --- CADE postpones the decision.
- **Oct 1995** --- CADE rules 4--2 for partial approval, ordering **deconstitution** of the Pains incorporation.
- **1995** --- parties refuse compliance; appeal to the **Minister of Justice**.
- **Nov 1995** --- Minister Jobim accepts the appeal (contra Art. 50), **suspending enforcement**.
- **1996** --- with **renewed composition**, CADE settles on remedies; Gerdau divests a rolling unit.

\vspace{0.3em}
\footnotesize *(Dates to be reconciled with the article's chronology; final settlement ran to 1998.)*
